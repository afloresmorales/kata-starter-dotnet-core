...
namespace Kata.Spec
{
    ...
    public class when_user_input_contains_negative_number
    {
        ...
        It should_do_something = () => { _result.Message.Should().Be("negatives not allowed: -2"); };
        static Calculator _systemUnderTest;
    ...
    public class when_user_input_contains_multiple_negatives
    {
        ...
        It should_raise_an_exception = () => { _result.Message.Should().Be("negatives not allowed: -2, -3"); };
        static Calculator _systemUnderTest;
        static Exception _result;
    }
